...
class Vendas_model extends CI_Model {
    ...
    function get($table, $fields, $where = '', $perpage = 0, $start = 0, $one = false, $array = 'array') {
        ...
        $this->db->select($fields . ', clientes.nomeCliente, clientes.idClientes, clientes.telefone as clienteTelefone');
        $this->db->from($table);
        ...
        $this->db->where('vendas.entidade', $entidade);
        $query = $this->db->get();
    ...
    function getById($id) {
        $this->db->select('vendas.*, clientes.*, usuarios.*, clientes.telefone as clienteTelefone');
        $this->db->from('vendas');
