                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="telefone" type="text" name="telefone" value="<?php echo $result->telefone; ?>" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}" />
                                <span class="required">*</span>
                            </div>
                        </div>
                        <div class="control-group">
...
<script type="text/javascript">
      $(document).ready(function(){
           $('#formCliente').validate({
            ...
            messages:{
                  nomeCliente :{ required: 'Preencha este campo.'},
                  telefone:{ required: 'Preencha este campo.'}
