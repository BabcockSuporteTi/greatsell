<?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aOs')) { ?>
    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar ordem de serviço</a>
<?php } ?>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/os/excluir" method="post" >
        <div class="modal-header">
            ...
            <h5 id="myModalLabel">Excluir ordem de serviço</h5>
        </div>
        <div class="modal-body">
            <input type="hidden" id="idOs" name="id" value="" />
            <h5>Deseja excluir esta ordem de serviço?</h5>
            <p>Todos os lançamentos vinculados a ela também serão excluídos.</p>
        </div>
