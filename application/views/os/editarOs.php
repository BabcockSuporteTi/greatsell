            ...
            <div class="widget-content nopadding">
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalhes da ordem de serviço</a></li>
                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 0 1% 0 1%; margin-left: 0">
                                        <h3 style="margin-top: 0">#Protocolo: <?php echo $result->idOs ?></h3>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2">
                                            ...
                                            <input id="dataFinal" class="span12 datepicker" type="text" name="dataFinal" value="<?php if (!empty($result->dataFinal)) echo date('d/m/Y', strtotime($result->dataFinal)); ?>"  />
                                        </div>
									...
									<div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <input id="placa" type="text" class="span12" name="placa" value="<?php echo $result->placa ?>"  />
                                        </div>
                                        <div class="span3">
                                            <label for="quilometragem">Quilometragem: </label>
                                            <input id="quilometragem" type="text" class="span12" name="quilometragem" value="<?php echo $result->quilometragem ?>"  />
                                        </div>										
									</div>
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6">
                                            <label for="descricaoProduto">Descrição: </label>
                                            <textarea class="span12" name="descricaoProduto" id="descricaoProduto" cols="30" rows="4"><?php echo $result->descricaoProduto ?></textarea>
                                        </div>
                                        <div class="span6">
                                            <label for="observacoes">Observações:</label>
                                            <textarea class="span12" name="observacoes" id="observacoes" cols="30" rows="4"><?php echo $result->observacoes ?></textarea>
                                        </div>
                                    </div>
                                    <div id="divTotais">
                                        <div class="span12" style="padding: 1%; margin-left: 0">
                                            <div class="span3">
                                                <label for="valorTotal">Total produtos e serviços: </label>
                                                <input class="dinheiro" id="valorTotal" readonly="true" type="text" name="valorTotal" value="R$ <?php echo number_format($result->valorTotal, 2, ",", "."); ?>"  />
                                            </div>	
                                            <div class="span3">
                                                <label for="valorDesconto">Desconto:</label>
                                                <input class="dinheiro" id="valorDesconto" type="text" name="valorDesconto" value="R$ <?php echo number_format($result->desconto, 2, ",", "."); ?>"  />
                                            </div>
                                        </div>
                                        <div class="span12" style="padding: 1%; margin-left: 0">
                                            <div class="span4"> 
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formProdutos" action="<?php echo base_url() ?>index.php/os/adicionarProduto" method="post">
                                    ...
                                    <div class="span2">
                                        ...
                                        <input type="text" class="span12" placeholder="Local" id="localCompra" name="localCompra"/>
                                    </div>                                    
									<div class="span2">
                                ...
                                <table class="table table-bordered" id="tblProdutos">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($produtos as $p) {
                                            ...
                                            echo '<td>' . $p->localCompra . '</td>';
                                            echo '<td>R$ ' . number_format($p->valor_unitario, 2, ',', '.');
                                            echo '<td>' . $p->quantidade . '</td>';
                                            echo '<td>R$ ' . number_format($p->quantidade * $p->valor_unitario, 2, ',', '.') . '</td>';
                                            echo '<td><a href="" idAcao="' . $p->idProdutos_os . '" prodAcao="' . $p->idProdutos . '" quantAcao="' . $p->quantidade . '" idOs="' . $result->idOs . '" title="Excluir Produto" class="btn btn-danger"><i class="icon-remove icon-white"></i></a></td>';
                                            echo '</tr>';
                                        }
                                        ?>
                                        <tr>
                        ...
                        <div class="tab-pane" id="tab3">
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formServicos" action="<?php echo base_url() ?>index.php/os/adicionarServico" method="post">
                                    ...
                                    <div class="span2">
                                        <label for="">Valor unitário: </label>
                                        <input type="text" class="dinheiro span12" placeholder="Valor unitário" id="valorUnitarioServico" name="valorUnitarioServico"/>
                                    </div>
                                    <div class="span2">
                                        <label for="">Quantidade: </label>
                                        <input type="text" placeholder="Quantidade" id="quantidadeServico" name="quantidadeServico" class="span12" />
                                    </div>
                                    <div class="span2">
                                        &nbsp;
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($servicos as $s) {
                                            $total = $total + ($s->quantidade * $s->valor_unitario);
                                            echo '<tr>';
                                            echo '<td>' . $s->nome . '</td>';
                                            echo '<td>R$ ' . number_format($s->valor_unitario, 2, ',', '.');
                                            echo '<td>' . $s->quantidade . '</td>';
                                            echo '<td>R$ ' . number_format($s->quantidade * $s->valor_unitario, 2, ',', '.') . '</td>';
                                            echo '<td><span idAcao="' . $s->idServicos_os . '" idOs="' . $result->idOs . '" title="Excluir Serviço" class="btn btn-danger"><i class="icon-remove icon-white"></i></span></td>';
                                            echo '</tr>';
                                        }
                                        ?>
                                        <tr>
    ...
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        ...
        <div class="modal-body">
            <div class="span12" style="margin-left: 0; padding: 5px;"> 
                ...
                <input class="span12" id="descricao" readonly="true" type="text" name="descricao" value="Fatura da OS #<?php echo $result->idOs; ?>"  />
            </div>  
            <div class="span12" style="margin-left: 0; padding: 5px;"> 
    ...
    $(document).ready(function () {
        ...
        $("#servico").autocomplete({
            ...
            select: function (event, ui) {
                ...
                $("#valorUnitarioServico").val(ui.item.preco).priceFormat({
                    prefix: 'R$ ',
                    centsSeparator: ',',
                    thousandsSeparator: '.'
                });
        ...
        $("#formServicos").validate({
            rules: {
                ...
                valorUnitarioServico: {required: true}
            },
            messages: {
                servico: {required: 'Campo obrigatório.'},
                quantidadeServico: {required: 'Campo obrigatório.'},
                valorUnitarioServico: {required: 'Campo obrigatório.'}
            },
            errorClass: "help-inline",
            errorElement: "span",
            highlight: function (element, errorClass, validClass) {
