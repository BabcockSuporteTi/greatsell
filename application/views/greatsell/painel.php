                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if($ordens != null){
                            ...
                            echo '<tr><td colspan="5">Nenhuma ordem de serviço em aberto.</td></tr>';
                        }    
                        ?>
                    </tbody>
                </table>
...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span4">
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Estatísticas financeiras - pago</h5></div>
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
    ...
    <div class="span4">
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Total em caixa</h5></div>
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Estatísticas de ordem de serviço</h5></div>
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">           
                    <div class="span12">
                        <ul class="site-stats">
                            <li class="bg_lh"><i class="icon-group"></i> <strong><?php echo $cliente_count;?></strong> <small>Clientes</small></li>
                            <li class="bg_lh"><i class="icon-barcode"></i> <strong><?php echo $produto_count;?></strong> <small>Produtos </small></li>
                            <li class="bg_lh"><i class="icon-tags"></i> <strong><?php echo $os_count;?></strong> <small>Ordens de Serviço</small></li>
                            <li class="bg_lh"><i class="icon-wrench"></i> <strong><?php echo $servico_count;?></strong> <small>Serviços</small></li>
                        </ul>
                    </div>
                </div>
            </div>
