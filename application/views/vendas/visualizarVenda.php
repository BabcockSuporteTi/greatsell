        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <div class="buttons">
                    ...
                    echo '<a id="imprimir" target="_blank" title="Imprimir" class="btn btn-mini btn-inverse" href="' . base_url() . 'index.php/relatorios/imprimirVenda/' . $result->idVendas . '"><i class="icon-print icon-white"></i> Imprimir</a>';                    
                    ?>
                </div>
            </div>
